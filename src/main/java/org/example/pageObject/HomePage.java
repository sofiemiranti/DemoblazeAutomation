...
public class HomePage {
    ...
    private WebElement laptopCategories;
    ...
    @FindBy(xpath = "//div[@id='tbodyid']/div[contains(.,'Sony vaio i5$790Sony is so confident that the VAIO S is a superior ultraportable')]")
    ...
    public boolean verifyRelevantItemLaptop() {
        return laptopItem.isDisplayed();
    }
